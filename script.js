...
function generateRaceWords() {
    const paragraph = "The Industrial Revolution, which began in the late 18th century, was a pivotal period of social and economic change that transformed Great Britain and the world. It was characterized by a shift from agrarian economies to industrial and urban ones. The invention of the steam engine by James Watt was a critical catalyst, powering new machinery in factories and improving transportation with steam-powered locomotives and ships. This mechanization revolutionized the textile industry, with inventions like the spinning jenny and power loom dramatically increasing production speed and volume. As factories grew, so did cities, with masses of people moving from rural areas to urban centers in search of work. This rapid urbanization led to overcrowded living conditions, poor sanitation, and new social challenges. The era also saw the rise of the factory system, which created a new working class and a wealthy industrial bourgeoisie, fundamentally altering social structures. The economic principles of capitalism, as articulated by Adam Smith, became dominant, emphasizing free markets and minimal government intervention. While the Industrial Revolution brought about immense technological progress and economic growth, it also created significant social and environmental problems, including harsh working conditions, child labor, and pollution. The period laid the groundwork for modern industrial society, and its effects continue to be felt today. The legacy of this transformative era is complex, a testament to human ingenuity and the profound societal shifts that can result from technological innovation. Understanding this period is essential to grasping the origins of many contemporary economic and social issues, from labor rights to environmental debates.";
